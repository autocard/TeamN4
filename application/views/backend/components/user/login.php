<html lang="">
	<head>
        ...
        <link rel="shortcut icon" href="public/images/neshotlogo.png" />
    ...
    <body>
        <div class="container khung">
            <div class="title">
            <img src="<?php echo base_url() ?>public/images/neshotlogo.png"width=100%>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2020 <a href="#" style="color:red">Tini Store</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
